...
namespace Kennel.Infrastructure.Migrations
{
    ...
    [Migration("20210510115623_Children+parrents")]
    partial class Childrenparrents
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kennel.Domain.Child.Child", b =>
                {
            ...
            modelBuilder.Entity("Kennel.Domain.Parrent.Parrent", b =>
                {
            ...
            modelBuilder.Entity("Kennel.Domain.Child.Child", b =>
                {
                    ...
                    b.OwnsOne("Kennel.Domain.Child.ChildId", "Id", b1 =>
                        {
                    ...
                    b.OwnsOne("Kennel.Domain.Child.IsDeleted", "IsDeleted", b1 =>
                        {
                            b1.Property<Guid>("ChildId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Kennel.Domain.Parrent.Parrent", b =>
                {
                    ...
                    b.OwnsOne("Kennel.Domain.Parrent.IsDeleted", "IsDeleted", b1 =>
                        {
                    ...
                    b.OwnsOne("Kennel.Domain.Parrent.ParrentId", "Id", b1 =>
                        {
                            b1.Property<Guid>("ParrentId")
                                .HasColumnType("uniqueidentifier");
