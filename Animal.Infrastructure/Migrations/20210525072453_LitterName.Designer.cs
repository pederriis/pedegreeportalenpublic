...
namespace Animal.Infrastructure.Migrations
{
    ...
    [Migration("20210525072453_LitterName")]
    partial class LitterName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Animal.Domain.Parenting.Parenting", b =>
                {
            ...
            modelBuilder.Entity("Animal.Domain.Litter.Litter", b =>
                {
                    ...
                    b.OwnsOne("Animal.Domain.Litter.LitterName", "LitterName", b1 =>
                        {
                            b1.Property<Guid>("LitterId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Animal.Domain.Parenting.Parenting", b =>
                {
                    ...
                    b.OwnsOne("Animal.Domain.Parenting.IsDeleted", "IsDeleted", b1 =>
                        {
                    ...
                    b.OwnsOne("Animal.Domain.Parenting.ParentingId", "Id", b1 =>
                        {
                            b1.Property<Guid>("ParentingId")
                                .HasColumnType("uniqueidentifier");
