...
namespace Animal.Infrastructure.Migrations
{
    ...
    [Migration("20210510075823_Child+Parrent")]
    partial class ChildParrent
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Animal.Domain.Child.Child", b =>
                {
            ...
            modelBuilder.Entity("Animal.Domain.Parrent.Parrent", b =>
                {
            ...
            modelBuilder.Entity("Animal.Domain.Child.Child", b =>
                {
                    ...
                    b.OwnsOne("Animal.Domain.Child.ChildId", "Id", b1 =>
                        {
                    ...
                    b.OwnsOne("Animal.Domain.Child.IsDeleted", "IsDeleted", b1 =>
                        {
                            b1.Property<Guid>("ChildId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Animal.Domain.Parrent.Parrent", b =>
                {
                    ...
                    b.OwnsOne("Animal.Domain.Parrent.IsDeleted", "IsDeleted", b1 =>
                        {
                    ...
                    b.OwnsOne("Animal.Domain.Parrent.ParrentId", "Id", b1 =>
                        {
                            b1.Property<Guid>("ParrentId")
                                .HasColumnType("uniqueidentifier");
