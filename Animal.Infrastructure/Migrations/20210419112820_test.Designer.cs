            ...
            modelBuilder.Entity("Animal.Domain.HealthRecord.HealthRecord", b =>
                {
                    ...
                    b.HasKey("AnimalId", "HealthRecordId");
            ...
            modelBuilder.Entity("Animal.Domain.HealthRecord.HealthRecord", b =>
                {
                    ...
                    b.OwnsOne("Animal.Domain.HealthRecord.HealthRecordId", "Id", b1 =>
                        {
                            b1.Property<Guid>("HealthRecordAnimalId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("HealthRecordAnimalId", "HealthRecordId");

                            b1.ToTable("HealthRecords");

                            b1.WithOwner()
                                .HasForeignKey("HealthRecordAnimalId", "HealthRecordId");
                        });
